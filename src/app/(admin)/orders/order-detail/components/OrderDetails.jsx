  ...
  return <>
      ...
      <CardBody>
        ...
        <p className="text-dark mb-0 fw-medium">
          Card Holder Name : <span className="text-muted fw-normal fs-13"> Hassaan Rasheed</span>
        </p>
      </CardBody>
    </>;
};
  ...
  return <>
      ...
      <CardBody>
        <div className="d-flex align-items-center gap-2">
          <Image src="/hassaan.png" width={50} height={50} alt="Hassaan Rasheed" className="avatar rounded-3 border border-light border-3" />
          <div>
            <p className="mb-1">Hassaan Rasheed</p>
