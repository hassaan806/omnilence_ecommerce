                  ...
                  <Col lg={12}>
                    ...
                    <div className="row justify-content-between mt-3 align-items-center">
                      <Col lg={6} xs={6}>
                        ...
                        <p className="text-dark fw-medium mb-0 mt-1">Hassaan Rasheed</p>
                        <p className="mb-0">contact@omnilence.com</p>
                      </Col>
                      <Col lg={4} xs={6} className="text-end">
                        <Image src="/hassaan.png" width={50} height={50} alt="Hassaan Rasheed" className="avatar rounded-circle" />
                      </Col>
                    </div>
                    <div className="row justify-content-between mt-3 align-items-center">
                      <Col lg={6} xs={6}>
