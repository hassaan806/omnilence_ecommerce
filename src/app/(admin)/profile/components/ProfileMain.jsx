        ...
        <Card className="overflow-hidden">
          <CardBody>
            <div className="bg-primary profile-bg rounded-top position-relative mx-n3 mt-n3">
              <Image src="/hassaan.png" alt="Hassaan Rasheed" width={100} height={100} className="avatar-xl border border-light border-3 rounded-circle position-absolute top-100 start-0 translate-middle ms-5" />
            </div>
            <div className="mt-5 d-flex flex-wrap align-items-center justify-content-between">
              <div>
                <h4 className="mb-1">
                  Hassaan Rasheed <IconifyIcon icon="bxs:badge-check" className="text-success align-middle" />
                </h4>
          ...
          <CardBody>
            <div>
              ...
              <div className="d-flex align-items-center gap-2 mb-2">
                ...
                <p className="mb-0 fs-14">
                  Lives in <span className="text-dark fw-semibold">Islamabad, PK 46000</span>
                </p>
              </div>
              <div className="d-flex align-items-center gap-2 mb-2">
                <div className="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
